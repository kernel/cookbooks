...
The demo defaults to `openai/gpt-5.6-terra` and is designed around its stronger reasoning and tool-driven computer-use patterns (see [GPT-5.6](https://openai.com/index/gpt-5-6/)).
