...
#
# ```
# modal run kernel_webscraper.py --prove
# ```
...
#
# ```
# modal run kernel_webscraper.py
# ```
#
# Scrape a public page with no login:
#
# ```
# modal run kernel_webscraper.py --url https://books.toscrape.com/ --no-with-auth
# ```
#
...
#
# ```
# modal deploy kernel_webscraper.py
# ```
