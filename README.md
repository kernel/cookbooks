...
| [e2e-kernel](integrations/e2e-kernel/)                                 | Agentic end-to-end testing against KERNEL documentation with e2e                            |
...
| [fx-colocated-agent](integrations/fx-colocated-agent/)                 | run Vercel's fx agent alongside the KERNEL browser it drives                                     |
